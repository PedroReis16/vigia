...
public interface IFiwareService
{
    ...
    /// registration de comandos no Orion e as subscrições de
    /// <c>Fiware:Subscriptions</c>. Idempotente: remove shadows, reprovisiona
    /// se faltar apikey, e reforça registration/subscrições.
    /// </summary>
